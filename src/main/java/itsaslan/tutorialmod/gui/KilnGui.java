...
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModVars.MOD_ID + ":textures/gui/container/kilnGui.png");

    public KilnGui(InventoryPlayer playerInventory, TileEntity tileEntity, Block block)
    {
        super(new KilnContainer(playerInventory, tileEntity));
        this.xSize = 176;
        this.ySize = 166;
    }
