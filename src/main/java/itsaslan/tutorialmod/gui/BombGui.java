...
public class BombGui extends GuiContainer
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(ModVars.MOD_ID + ":textures/gui/container/bombGui.png");

    public BombGui(InventoryPlayer playerInventory, TileEntity tileEntity, Block block)
    {
        super(new BombContainer(playerInventory, tileEntity));
        this.xSize = 176;
        this.ySize = 166;
    }
